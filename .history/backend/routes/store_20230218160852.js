...
router.post('/', (req, res) => {
    const toSend = "Here is the text that I will reference: '"+req.body.prompt+"'. Please generate me a bullet pointed list of the main ideas of the text, in bullet point format.";
    ...
    response.then((data) => {
        ...
        res.send({text: req.body.prompt, mainIdeas: mainIdeas});
    });
});
