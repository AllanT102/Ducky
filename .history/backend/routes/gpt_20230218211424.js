...
router.post('/', (req, res) => {
    ...
    const toSend = "Here is the text that I will reference: '"+got.text+"'. I know that a list of the main ideas of this text are" + got.keyElemArray + "."
     + "Secondly, I also know that " + req.body.prompt + ". If that is in the list of main ideas of the text, can you cross it out and regenerate the list of main ideas of the text?";
